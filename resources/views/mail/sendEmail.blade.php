...
<table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 14px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 34px; line-height: 47.6px; font-family: Rubik, sans-serif;"><strong><span style="line-height: 19.6px;"> {{ $data_email['isi']['status'] }}</span></strong></span></p>
  </div>
...
<p style="line-height: 200%; text-align: left;"><strong>Nama</strong> :</p>
<p style="line-height: 200%; text-align: left;"> {{ $data_email['isi']['nama_asesi'] }}</p>
<p style="line-height: 200%; text-align: left;"> </p>
<p style="line-height: 200%; text-align: left;"><strong>Rekomendasi</strong> : </p>
<p style="line-height: 200%; text-align: left;"> {{ $data_email['isi']['rekomendasi'] }}</p>
<p style="line-height: 200%; text-align: left;"> </p>
<p style="line-height: 200%; text-align: left;"><strong>Keterangan</strong> :</p>
<p style="line-height: 200%; text-align: left;"> {{ $data_email['isi']['keterangan'] }}</p>
<p style="line-height: 200%; text-align: left;"> </p>
<p style="line-height: 200%; text-align: left;"><strong>Aspek Negatif dan Positif Dalam Asesmen</strong> :</p>
<p style="line-height: 200%; text-align: left;"> {{ $data_email['isi']['aspek'] }}</p>
<p style="line-height: 200%; text-align: left;"> </p>
<p style="line-height: 200%; text-align: left;"><strong>Pencatatan Penolakan Hasil Asesmen </strong> :</p>
<p style="line-height: 200%; text-align: left;"> {{ $data_email['isi']['pencatatan_penolakan'] }}</p>
<p style="line-height: 200%; text-align: left;"> </p>
<p style="line-height: 200%; text-align: left;"><strong>Saran Perbaikan (Asesor / personil terkait) </strong> :</p>
<p style="line-height: 200%; text-align: left;"> {{ $data_email['isi']['saran_perbaikan'] }}</p>
<p style="line-height: 200%; text-align: left;"> </p>
  </div>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="https://seeklogo.com/images/B/badan-nasional-sertifikasi-profesi-bnsp-logo-6E3B5BF459-seeklogo.com.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 35%;max-width: 203px;" width="203"/>
...
<table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 14px; color: #b8b8b8; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;">Call us: 0853 2948 9247<br />EMAIL: info@smkn2cikbar.com <br />Jl. Fatahillah No 1A RW 04 Kalijaya Cikarang Barat Bekasi</p>
<p style="font-size: 14px; line-height: 140%;">Jawa Barat, Kalijaya, Kec. Cikarang Bar., Kabupaten Bekasi<br />Jawa Barat 17530</p>
  </div>
...
<table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 14px; color: #bbbbbb; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 12px; line-height: 16.8px;">© Copyright 2023  |  All Rights Reserved </span></p>
  </div>
