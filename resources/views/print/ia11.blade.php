...
<div class="row">
  ...
  <div class="col-md-12 mt-2">
    <div class="col-md-4" style="display:inline">Nama Peninjau :</div>
    <div class="col-md-8">{{ $asesor }}</div>
  </div>
  <div class="col-md-12 mt-2">
    <div class="col-md-4" style="display:inline">Tanggal :</div>
    <div class="col-md-8">{{ $skemaSertifikasi['mulai'] }}</div>
  </div>
  <div class="col-md-12 mt-2">
    <div class="col-md-4" style="display:inline">Komentar :</div>
    <div class="col-md-8">{{ $data['ia_11']['komentar'] }}</div>
  </div>
</div>