      ...
      <table class="table">
        <thead>
          <tr class="border-grey-header">
            <th scope="col" class="bg-grey-header border-grey-header col-no text-secondary" @click="handleChangeSort">
              <div class="d-flex is-align-items-center">
                <div class="d-flex justify-content-center align-items-center">No</div>
                <div class="d-flex justify-content-center align-items-center">
                  <svg :class="isAscending ? 'rotate-180' : 'rotate-0'" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path 
        ...
        <tbody>
          <tr v-for="(row, rowIndex) in rows" :key="rowIndex" class="dotted-border-bottom">
