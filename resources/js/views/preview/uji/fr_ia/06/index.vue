<template>
  <el-container v-if="$route.params.ia06 == null" class="app-container">
    <el-header>
  ...
  <el-container v-else class="app-container">
    ...
    <el-main>
      <div>
        ...
        <br>
        <el-button-group>
          <router-link :to="{name: 'preview-ia-05', params: { iduji: $route.params.iduji, idskema: $route.params.idskema, asesor: $route.params.asesor, ia05: dataPreview.id_ia_05 }}"><el-button type="primary" icon="el-icon-arrow-left">Previous Page</el-button></router-link>
          <router-link :to="{name: 'preview-ia-07', params: { iduji: $route.params.iduji, idskema: $route.params.idskema, asesor: $route.params.asesor, ia07: dataPreview.id_ia_07}}"><el-button type="primary" icon="el-icon-arrow-right">Next Page</el-button></router-link>
        </el-button-group>
      </div>
    </el-main>
  ...
  methods: {
    ...
    async getIa06() {
      ...
      if (this.dataPreview.id_ia_06 !== null) {
        ...
        console.log(this.listSoal[0].jawaban);
        this.loading = false;
      }
    },
    async getListSkema() {
