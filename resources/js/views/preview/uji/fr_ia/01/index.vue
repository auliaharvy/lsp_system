<template>
  <el-container
    v-if="dataPreview.id_ia_01 == null"
    v-loading="loading"
    class="app-container"
  >
    <el-header>
      <el-page-header
        content="FORM FR.IA.01 BELUM DIISI"
        @back="$router.back()"
      />
      <el-dropdown
        split-button
      ...
      <el-button-group>
        <router-link :to="{name: 'preview-ak-04', params: { iduji: $route.params.iduji, asesor: $route.params.asesor }}">
          <el-button
            type="primary"
  ...
  >
    <el-header>
      ...
      <span>
        <el-button-group>
          <router-link :to="{name: 'preview-ak-04', params: { iduji: $route.params.iduji, asesor: $route.params.asesor }}"><el-button
            type="primary"
            icon="el-icon-arrow-left"
    ...
    <el-main v-loading="loading">
      <div>
        ...
        >
          ...
          >
            ...
            <template slot-scope="scope">
              <template v-if="scope.row.type === 'kuk'">
                <div>{{ scope.row.is_kompeten ? 'Belum Kompeten' : 'Kompeten' }}</div>
          ...
          >
            <template slot-scope="scope">
              <div>{{ scope.row.penilaian_lanjut }}</div>
            </template>
          </el-table-column>
        </el-table>
