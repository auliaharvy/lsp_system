<template>
  <el-container v-if="dataPreview.id_ak_01 == null" v-loading="loading" class="app-container">
    <el-header>
      <el-page-header content="FORM FR.AK.01 BELUM DIISI" @back="$router.back()" />
      <el-dropdown split-button type="primary">
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <el-dropdown-item><router-link :to="{ name: 'preview-ak-07', params:{ iduji: $route.params.iduji, idskema: dataPreview.id_skema, asesor: $route.params.asesor, apl01: dataPreview.id_apl_01, apl02: dataPreview.id_apl_02, mapa02: dataPreview.id_mapa_02, ak01: dataPreview.id_ak_01, ak04: dataPreview.id_ak_04, ia01: dataPreview.id_ia_01, ia02: dataPreview.id_ia_02, ia03: dataPreview.id_ia_03, ia05: dataPreview.id_ia_05, id06: dataPreview.id_ia_06, ia07: dataPreview.id_ia_07, ia11: dataPreview.id_ia_11, ak02: dataPreview.id_ak_02, ak03: dataPreview.id_ak_03, ak05: dataPreview.id_ak_05, ak06: dataPreview.id_ak_06, ak07: dataPreview.id_ak_07, va: dataPreview.id_va }}">AK 07</router-link></el-dropdown-item>
      ...
      <el-button-group>
        <router-link :to="{ name: 'preview-mapa-02', params: { iduji: $route.params.iduji, asesor: $route.params.asesor }}"><el-button type="primary" icon="el-icon-arrow-left">Previous Page</el-button></router-link>
        <router-link :to="{ name: 'preview-ak-04', params: { iduji: $route.params.iduji, asesor: $route.params.asesor }}"><el-button type="primary" icon="el-icon-arrow-right">Next Page</el-button></router-link>
      </el-button-group>
    </el-header>
  </el-container>
          ...
          <el-table-column align="left">
            <template slot-scope="scope">
              <template v-if="scope.row.content !== '.'">
                <template v-if="scope.row.content === '-'">
                  <span>{{ verifikasi_portofolio ? ' Verifikasi Portofolio,' : '' }}</span>
                  <span>{{ observasi_langsung ? ' Observasi Langsung,' : '' }}</span>
                  <span>{{ hasil_tes_tulis ? ' Hasil Tes Tulis,' : '' }}</span>
                  <span>{{ hasil_tes_lisan ? ' Hasil Tes Lisan,' : '' }}</span>
