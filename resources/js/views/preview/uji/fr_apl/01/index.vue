<template>
  <el-container v-if="dataPreview.id_apl_01 == null" v-loading="loading" class="app-container">
    <el-header>
      ...
      <el-button-group>
        ...
        <router-link :to="{ name: 'preview-apl-02', params: { iduji: $route.params.iduji, asesor: $route.params.asesor }}"><el-button type="primary" icon="el-icon-arrow-right">Next Page</el-button></router-link>
      </el-button-group>
    </el-header>
  </el-container>
