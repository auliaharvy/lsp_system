...
Route::namespace('Api')->group(function() {
    ...
    Route::get('preview-ak-07-potensi-asesi/{id}', 'UjiKompController@previewAk07PotensiAsesi');
    Route::get('preview-ak-07-persyaratan/{id}', 'UjiKompController@previewAk07Persyaratan');
